...
class AddCollectionSchema(BaseModel):
    ...
    size: int = Field(default=1024, ge=1, description="Введите размер векторной размерности")
    distance: str = Field(default="COSINE", min_length=1, description="Введите вид расстояния")
